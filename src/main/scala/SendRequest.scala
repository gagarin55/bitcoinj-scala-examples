...
object SendRequest extends App {
  override def main(args: Array[String]): Unit = {
    ...
    // Have a look at the Kit.java example for more details.
    ...
    val to: Address = Address.fromBase58(params, "mupBAFeT63hXfeeT4rnAUcpKHDkz1n4fdw")

    // There are different ways to create and publish a SendRequest.
    // This is probably the easiest one.
    // Have a look at the code of the SendRequest class to see what's happening and
    // what other options you have: https://bitcoinj.github.io/javadoc/0.11/com/google/bitcoin/core/Wallet.SendRequest.html
    //
